...
train_label_pred = softmax_classifier.predict(X_train)
test_label_pred = softmax_classifier.predict(X_test)
...
print("*" * 100)
softmax_classifier_noise = LogisticRegression(multi_class='ovr', solver='liblinear', random_state=42)
softmax_classifier_noise.fit(X_train_copy, y_train)
train_label_pred_noise = softmax_classifier_noise.predict(X_train_copy)
test_label_pred_noise = softmax_classifier_noise.predict(X_test_copy)
...
#
# softmax_classifier_repair = LogisticRegression(multi_class='ovr', solver='liblinear', random_state=42)
# softmax_classifier_repair.fit(X_train_copy, y_train)
# y_train_pred = softmax_classifier_repair.predict(X_train_copy)
# y_test_pred = softmax_classifier_repair.predict(X_test_copy)
#
# print("*" * 100)
# # 训练样本中被softmax模型错误分类的样本
