...
train_label_pred = knn_classifier.predict(X_train)
test_label_pred = knn_classifier.predict(X_test)
...
print("*" * 100)
knn_classifier_noise = KNeighborsClassifier(n_neighbors=22)
knn_classifier_noise.fit(X_train_copy, y_train)
train_label_pred_noise = knn_classifier_noise.predict(X_train_copy)
test_label_pred_noise = knn_classifier_noise.predict(X_test_copy)
...
#
# knn_classifier_repair = KNeighborsClassifier(n_neighbors=22)
# knn_classifier_repair.fit(X_train_copy, y_train)
# y_train_pred = knn_classifier_repair.predict(X_train_copy)
# y_test_pred = knn_classifier_repair.predict(X_test_copy)
#
# print("*" * 100)
# # 训练样本中被KNN模型错误分类的样本
...
predict_fn = lambda x: knn_classifier.predict_proba(x)
