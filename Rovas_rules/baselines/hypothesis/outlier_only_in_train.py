"""
原始的rova_repair_svm.py文件修改了测试集，本文件保证测试集不变，评估模型效果
仅在训练集中引入异常，保持测试集是正常数据
"""
import pandas as pd
...
# 随机选择要添加噪声的样本
noise_train_indices = np.random.choice(n_samples, n_noise, replace=False)
noise_indices = train_indices[noise_train_indices]
