...
knn_classifier.fit(X_train_copy, y_train)
...
# 预测每个样本被划分到的类别
predicted_labels = knn_classifier.predict(X_copy)
...
print("*" * 100)
train_label_pred_noise = knn_classifier.predict(X_train_copy)
test_label_pred_noise = knn_classifier.predict(X_test_copy)
...
# # subsection 重新在修复后的数据上训练knn模型
#
# svm_repair = KNeighborsClassifier(n_neighbors=22)
