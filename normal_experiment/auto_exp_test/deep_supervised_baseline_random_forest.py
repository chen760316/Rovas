...
# D:\CodeWork\python\outlier\Rovas\normal_experiment\datasets
# choice drybean数据集(效果好)
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/drybean.xlsx"
# data = pd.read_excel(file_path)

# choice obesity数据集(效果好)
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/obesity.csv"
# data = pd.read_csv(file_path)

# choice balita数据集(SVM拟合效果差，但修复后效果提升显著)
#  file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/balita.csv"
# data = pd.read_csv(file_path)

# choice apple数据集(效果提升小)
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/apple.csv"
# data = pd.read_csv(file_path)

# choice adult数据集(效果提升明显)
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/adult.csv"
# data = pd.read_csv(file_path)

# choice body数据集(执行较慢，SVM拟合效果很差，但修复后效果有提升)
file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/body/body.csv"
data = pd.read_csv(file_path)
...
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/financial/financial.csv"
# data = pd.read_csv(file_path)

# choice online(SVM拟合效果相对较差，但修复后效果提升显著)
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/online/online.csv"
# data = pd.read_csv(file_path)

# choice star(SVM拟合相对准确，修复后效果提升显著)
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/star/star.csv"
# data = pd.read_csv(file_path)

# choice student(SVM拟合相对较差，修复后效果提升显著)
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/student/Student.csv"
# data = pd.read_csv(file_path)
...
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/Cardiotocography.csv"
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/annthyroid.csv"
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/optdigits.csv"
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/PageBlocks.csv"
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/pendigits.csv"
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/satellite.csv"
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/shuttle.csv"
# file_path = "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/yeast.csv"
def run(file_path):
...
if __name__ == '__main__':
    paths = [
    "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/drybean.xlsx",
    "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/obesity.csv",
    "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/balita.csv",
    "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/apple.csv",
    "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/adult.csv"
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/body/body.csv",
    # # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/financial/financial.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/online/online.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/star/star.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/multi_class/student/Student.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/Cardiotocography.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/annthyroid.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/optdigits.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/PageBlocks.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/pendigits.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/satellite.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/shuttle.csv",
    # "D:/CodeWork/python/outlier/Rovas/normal_experiment/datasets/real_outlier/yeast.csv"
   ]
    res_list = [[],[],[],[]]
    for path in paths:
        print("*" * 100)
        print("当前数据集：" + path)
        acc, precision, recall, f1 = run(path)
        res_list[0].append(str(acc))
        res_list[1].append(str(precision))
        res_list[2].append(str(recall))
        res_list[3].append(str(f1))
    
    resrow = list(zip(res_list[0], res_list[1], res_list[2], res_list[3]))
    df = pd.DataFrame(resrow, columns=['Accuracy', 'Precision', 'Recall', 'F1'])
